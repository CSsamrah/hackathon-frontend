...
const AssignmentsPage = ({ teacherId }) => {
  ...
  useEffect(() => {
    const fetchAssignments = async () => {
      try {
        const response = await fetch(`https://hackathon-backend-gamma.vercel.app/api/studentsSubmitted/${teacherId}`);
  ...
  const handleMarksChange = async (submissionId, value) => {
    ...
    try {
      const response = await fetch(`https://hackathon-backend-gamma.vercel.app/api/marks/${submissionId}`, {
        method: 'PUT',
        headers: {
  ...
  const handleStatusChange = async (submissionId, value) => {
    ...
    try {
      const response = await fetch(`https://hackathon-backend-gamma.vercel.app/api/remarks/${submissionId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleViewAssignment = async (submissionId) => {
    ...
    try {
      const response = await fetch(`https://hackathon-backend-gamma.vercel.app/api/getAssignment/${submissionId}`);
      const result = await response.json();
